...
import { getOrderDetails, PaymentAction } from '../actions/OrderActions'
...
function OrderDetails({ match, history }) {
    ...
    }, [dispatch, orderId, paymentDetail, orderDetails])
                                    ...
                                    <ListGroup.Item>
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <strong>
                                                    { 
                                                        Number(orderDetails.taxPrice) + Number(orderDetails.shippingPrice) + Number(orderDetails.totalPrice)
                                                    }
                                                </strong>
                                            </Col>
                                        </Row>
                                    </ListGroup.Item>
                                    {
                                        ...
                                        paymentDetail ? 
                                            <ListGroup>
                                                ...
                                                <ListGroup.Item>
                                                    <Button className='btn-block' onClick={continueShopping}>Continue Shopping</Button>
                                                </ListGroup.Item>
                                            </ListGroup>
